...
# directories
DATA_DIR = 'D:\\DataScience\\taipei_machine_learning-master\\Quora\\Data\\'
SUBMISSIONS_DIR = 'D:\\DataScience\\taipei_machine_learning-master\\Quora\\Submissions\\'
TRAINING_DATA_FILE = 'train.csv'
TEST_DATA_FILE = 'test.csv'
EMBEDDING_FILE = 'D:\Datasets\GoogleNews-vectors-negative300.bin'
MODEL_WEIGHTS_FILE = 'question-pairs-weight.h5'
...
submission.to_csv('%.4f_'%(best_val_score)+'.csv', index=False)
